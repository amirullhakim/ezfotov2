      ...
      <div className="flex min-h-screen">
        ...
        <aside className="hidden w-[260px] shrink-0 border-r border-[#E3EAEC] bg-white lg:flex lg:flex-col">
          ...
          <div className="mt-auto border-t border-[#EDF1F2] p-4">
            ...
            <button className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#667A83] hover:bg-[#F6F9FA]">
            ...
            <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
              ...
              <div>
                ...
                <p className="mt-3 max-w-xl text-sm leading-6 text-[#6A7E86]">
                  Build your photography presence and manage
                  every part of your EZFOTOO workspace.
                </p>
              </div>
                ...
                <div className="mt-6 space-y-3">
                  ...
                  {workspace.services.map(
                    (service) => (
                      <div
                        key={service.code}
                        className="flex items-center justify-between rounded-2xl border border-[#E5ECEE] bg-[#FBFCFC] p-4"
                      >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <ChevronRight className="h-4 w-4 text-[#9DADB2]" />
              ...
              <section className="space-y-5">
                ...
                <div className="ez-card p-6">
                  ...
                  <p className="mt-3 text-xs leading-5 text-[#899A9F]">
                    Your photographer website will be published
                    here when the Website service is activated.
                  </p>
                ...
                <div className="rounded-[22px] bg-[#073B4C] p-6 text-white">
                  ...
                  <p className="mt-2 text-sm leading-6 text-[#B8CDD2]">
                    We will build each service step by step while
                    keeping everything under one professional
                    photography brand.
                  </p>
